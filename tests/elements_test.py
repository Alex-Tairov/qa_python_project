...
import time
import allure
from pages.elements_page import LinksPage,UploadAndDownloadPage,DynamicPropertiesPage,TextBoxPage,CheckBoxPage,\
    RadioButtonPage,WebTablePage,ButtonsPage

@allure.suite("Elements")
class TestElements:
    @allure.feature("TextBox")
    class TestTextBox:
        @allure.title("CheckTextBox")
